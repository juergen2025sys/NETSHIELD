...
**Aktualisiert:** 2026-05-30 20:16 UTC
...
| `Production Health` | Push-Limit Naehe | seen_db_backup.json.gz: 80.7 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🔴 CRITICAL | active ⊆ conf40 Subset-Invariante verletzt | 1,623 IPs in active fehlen in conf40 (0.387% von active). Ursache vermutlich Cache-Drift zwischen combined- und confidence-Workflow (siehe BUG-CACHE-DRIFT). Der Heilungs-Pfad in update_confidence_blacklist.yml hat entweder nicht gegriffen (Cap >10%) oder wurde umgangen. |
| 🟡 WARN | Push-Limit Naehe | seen_db_backup.json.gz: 80.7 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-05-30 20:16 UTC | 23 Workflow-Dateien geprüft*