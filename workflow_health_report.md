...
**Aktualisiert:** 2026-06-02 06:01 UTC
...
| `Production Health` | Push-Limit Naehe | seen_db_backup.json.gz: 83.0 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 81.3 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🟡 WARN | Push-Limit Naehe | seen_db_backup.json.gz: 83.0 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
| 🟡 WARN | Push-Limit Naehe | blacklist_geo_enriched.json: 93.8 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
| 🟡 WARN | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 81.3 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-02 06:01 UTC | 24 Workflow-Dateien geprüft*