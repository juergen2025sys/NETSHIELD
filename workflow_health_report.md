...
**Aktualisiert:** 2026-06-12 16:27 UTC
...
| `Production Health` | Push-Limit Naehe | seen_db_backup.json.gz: 88.4 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🟡 WARN | Push-Limit Naehe | seen_db_backup.json.gz: 88.4 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-12 16:27 UTC | 24 Workflow-Dateien geprüft*