...
**Aktualisiert:** 2026-06-06 05:04 UTC
...
| `Production Health` | Push-Limit Naehe | seen_db_backup.json.gz: 85.2 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🟡 WARN | Push-Limit Naehe | seen_db_backup.json.gz: 85.2 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-06 05:04 UTC | 24 Workflow-Dateien geprüft*