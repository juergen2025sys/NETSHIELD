...
**Aktualisiert:** 2026-04-04 19:28 UTC
...
| Datei | Check | Detail |
|---|---|---|
| `update_bot_detector.yml` | Report nach Guard-Exit | Block 0 L~116: sys.exit(1) vor Report/Status-Write (OUT_FILE, bot_detector_report.md) – stale Report moeglich trotz Commit-Step mit if: always() |
...
---
*Generiert: 2026-04-04 19:28 UTC | 16 Workflow-Dateien geprüft*