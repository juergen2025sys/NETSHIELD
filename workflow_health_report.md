...
**Aktualisiert:** 2026-06-12 06:00 UTC
...
| `Production Health` | Push-Limit Naehe | seen_db_backup.json.gz: 88.2 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🟡 WARN | Push-Limit Naehe | seen_db_backup.json.gz: 88.2 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-12 06:00 UTC | 24 Workflow-Dateien geprüft*