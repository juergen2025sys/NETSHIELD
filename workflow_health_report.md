...
**Aktualisiert:** 2026-05-06 09:36 UTC
...
| Datei | Check | Detail |
|---|---|---|
| `Production Health` | Aktualität: Active Blacklist (Stufe 2) | active_blacklist_ipv4.txt ist 6h alt (WARN-Schwelle: 6h) |
| `Production Health` | Aktualität: Combined Blacklist (Stufe 1) | combined_threat_blacklist_ipv4.txt ist 6h alt (WARN-Schwelle: 6h) |
...
| Level | Check | Detail |
|---|---|---|
| 🟡 WARN | Aktualität: Active Blacklist (Stufe 2) | active_blacklist_ipv4.txt ist 6h alt (WARN-Schwelle: 6h) |
| 🟡 WARN | Aktualität: Combined Blacklist (Stufe 1) | combined_threat_blacklist_ipv4.txt ist 6h alt (WARN-Schwelle: 6h) |
...
---
*Generiert: 2026-05-06 09:36 UTC | 19 Workflow-Dateien geprüft*