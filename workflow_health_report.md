...
**Aktualisiert:** 2026-06-07 14:59 UTC
...
| `Production Health` | Push-Limit Naehe | seen_db_backup.json.gz: 85.9 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| `Production Health` | Truncate-Parts wachsen | blacklist_geo_enriched.json: 1 neue Parts hinzugekommen (3 total). Wachstumstrend pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🟡 WARN | Push-Limit Naehe | seen_db_backup.json.gz: 85.9 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| 🟡 WARN | Truncate-Parts wachsen | blacklist_geo_enriched.json: 1 neue Parts hinzugekommen (3 total). Wachstumstrend pruefen. |
...
---
*Generiert: 2026-06-07 14:59 UTC | 24 Workflow-Dateien geprüft*