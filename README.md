...
| 📦 Combined | 🔴 Active | 🟡 Confidence ≥40 | 🟠 Watchlist | 🚨 CVE/Exploit | 🍯 Honeypot | 📡 Feeds |
|:-----------:|:---------:|:-----------------:|:------------:|:--------------:|:-----------:|:--------:|
| **4,112,169** IPs | **2,381,047** IPs | **2,900,870** IPs | **322,287** IPs | **217,542** IPs | **10,111** IPs | **98** Quellen |

<br/>

| 🕐 Letztes Update | 🔄 Update-Intervall | 📅 IP-Retention | ⚙️ Workflows | 🌍 Länder |
|:-----------------:|:-------------------:|:---------------:|:------------:|:---------:|
| <!-- LAST_UPDATE --> | **8× täglich** (alle 3h) | **180 Tage** | **16** aktiv | **250+** |
