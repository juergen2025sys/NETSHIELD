...
|---|---|---|
| [combined_threat_blacklist_ipv4.txt](https://raw.githubusercontent.com/juergen2025sys/NETSHIELD/main/combined_threat_blacklist_ipv4.txt) | Aggregierte Threat-IPs aus ~80 Quellen (Vollarchiv 365 Tage) | **2,859,128** |
