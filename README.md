...
|:---|:---|:---|:---|
| – (dynamisch) | **2,561,559** | **56,349** | **8,056** |
<!-- STATS_TABLE_END -->
...
|:---|:---|:---|:---|:---|
| 2026-04-12 09:11 UTC | 8× täglich | 180 Tage | 16 | 250+ Länder |
<!-- META_TABLE_END -->
...
|---|---|---:|---|
| [`active_blacklist_ipv4.txt`](active_blacklist_ipv4.txt) | Aktive Bedrohungen · letzte 30 Tage · Score ≥ 65 | **2,561,559**                                                                                            | OPNsense / pfSense / Firewall |
...
| [`combined_threat_blacklist_ipv4.txt`](combined_threat_blacklist_ipv4.txt) | Alle IPs · 180-Tage-Fenster | **4,384,740**                                                                                            | Audit / SIEM |
