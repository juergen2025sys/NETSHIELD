...
| [`combined_threat_blacklist_ipv4.txt`](combined_threat_blacklist_ipv4.txt) | Alle IPs (180 Tage) | **2,909,100** | 8x täglich | Audit / SIEM |
...
| [`vpn_proxy_ranges.txt`](vpn_proxy_ranges.txt) | VPN/Proxy/Datacenter | **55,442** | wöchentlich Mo | Proxy-Erkennung |
