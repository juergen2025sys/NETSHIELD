...
<tr>
<td align="center" valign="top" width="25%" style="border:1px solid #000;padding:10px;">
<h3>286</h3>
...
<!-- META_TABLE_START -->
<table style="border-collapse:collapse;width:100%;border:2px solid #000;margin-top:8px;">
<tr>
<td style="border:1px solid #000;padding:6px 10px;"><strong>🕒 Letztes Update</strong></td>
<td style="border:1px solid #000;padding:6px 10px;">2026-08-09 12:39 CEST (Europe/Berlin)</td>
<td style="border:1px solid #000;padding:6px 10px;"><strong>🔄 Intervall</strong></td>
<td style="border:1px solid #000;padding:6px 10px;">8× täglich</td>
</tr>
<tr>
<td style="border:1px solid #000;padding:6px 10px;"><strong>📅 IP-Retention</strong></td>
<td style="border:1px solid #000;padding:6px 10px;">180 Tage</td>
<td style="border:1px solid #000;padding:6px 10px;"><strong>⚙️ Aktive Workflows</strong></td>
<td style="border:1px solid #000;padding:6px 10px;">26</td>
</tr>
<tr>
<td style="border:1px solid #000;padding:6px 10px;"><strong>🌍 Abdeckung</strong></td>
<td colspan="3" style="border:1px solid #000;padding:6px 10px;">250+ Länder</td>
</tr>
</table>
<!-- META_TABLE_END -->
...
*Zahlen zu Intervall, Aufbewahrung und Anzahl Workflows siehe Dashboard oben.*
