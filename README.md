...
|---|---|---:|---|---|
| [`active_blacklist_ipv4.txt`](active_blacklist_ipv4.txt) | Aktive Bedrohungen (30T + Conf≥50) | **2,588,295**                                                                                         | 8x täglich | **OPNsense / Firewall** |
| [`combined_threat_blacklist_ipv4.txt`](combined_threat_blacklist_ipv4.txt) | Alle IPs (180 Tage) | **3,969,459**                                                                                         | 8x täglich | Audit / SIEM |
...
| [`honeypot_ips.txt`](honeypot_ips.txt) | Honeypot-bestätigte IPs | **11,235**                                                                                         | täglich 23:00 | Ergänzung |
| [`honeydb_ips.txt`](honeydb_ips.txt) | HoneyDB Community Honeypot (API) | **12,656**                                                                                         | täglich 22:15 | Ergänzung |
