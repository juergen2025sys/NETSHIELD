...
| [`honeypot_ips.txt`](honeypot_ips.txt) | Honeypot-bestätigte IPs | **0**                                                                      | täglich 23:00 | Ergänzung |
| [`honeydb_ips.txt`](honeydb_ips.txt) | HoneyDB Community Honeypot (API) | **0**                                                                      | täglich 22:15 | Ergänzung |
| [`bot_detector_blacklist_ipv4.txt`](bot_detector_blacklist_ipv4.txt) | Bot-Detector | **15,458**                                                                      | täglich 23:45 | Web-Schutz |
