...
| [`blacklist_confidence40_ipv4.txt`](blacklist_confidence40_ipv4.txt) | Mittleres/Hohes Vertrauen (Score ≥40) | **2,796,740**                                                                                                                                                                                                                                                                                                                   | 8x täglich | Zusätzliche Filterregeln |
| [`watchlist_confidence20to39_ipv4.txt`](watchlist_confidence20to39_ipv4.txt) | Watchlist (Score 25–39) | **327,909**                                                                                                                                                                                                                                                                                                                   | 8x täglich | Monitoring |
| [`cve_exploit_ips.txt`](cve_exploit_ips.txt) | CVE-Exploit & C2-Server | **222,234**                                                                                                                                                                                                                                                                                                                   | täglich 04:00 | IDS/IPS |
