...
|---|---|---:|---|---|
| [`active_blacklist_ipv4.txt`](active_blacklist_ipv4.txt) | Aktive Bedrohungen (30T + Conf≥65) | **2,265,955**                                                                                                                                                                                                                                                                 | 8x täglich | **OPNsense / Firewall** |
| [`combined_threat_blacklist_ipv4.txt`](combined_threat_blacklist_ipv4.txt) | Alle IPs (180 Tage) | **3,936,906**                                                                                                                                                                                                                                                                 | 8x täglich | Audit / SIEM |
| [`blacklist_confidence40_ipv4.txt`](blacklist_confidence40_ipv4.txt) | Mittleres/Hohes Vertrauen (Score ≥40) | **2,757,594**                                                                                                                                                                                                                                                                 | 8x täglich | Zusätzliche Filterregeln |
| [`watchlist_confidence20to39_ipv4.txt`](watchlist_confidence20to39_ipv4.txt) | Watchlist (Score 25–39) | **338,079**                                                                                                                                                                                                                                                                 | 8x täglich | Monitoring |
| [`cve_exploit_ips.txt`](cve_exploit_ips.txt) | CVE-Exploit & C2-Server | **225,792**                                                                                                                                                                                                                                                                 | täglich 04:00 | IDS/IPS |
| [`honeypot_ips.txt`](honeypot_ips.txt) | Honeypot-bestätigte IPs | **9,256**                                                                                                                                                                                                                                                                 | täglich 23:00 | Ergänzung |
| [`honeydb_ips.txt`](honeydb_ips.txt) | HoneyDB Community Honeypot (API) | **10,077**                                                                                                                                                                                                                                                                 | täglich 22:15 | Ergänzung |
