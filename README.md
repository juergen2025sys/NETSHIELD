...
|---|---|---:|---|
| 🛡️ [`active_blacklist_ipv4.txt`](active_blacklist_ipv4.txt) | Aktive Bedrohungen · letzte 30 Tage · Score ≥ 65 | **423,976**                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | OPNsense / pfSense / Firewall |
...
| 📦 [`combined_threat_blacklist_ipv4.txt`](combined_threat_blacklist_ipv4.txt) | Alle IPs · 180-Tage-Fenster | **5,784,630**                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Audit / SIEM |
...
| 🍯 [`honeypot_ips.txt`](honeypot_ips.txt) | Honeypot-bestätigte Angreifer | **108,321**                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Ergänzung |
| 🍯 [`honeydb_ips.txt`](honeydb_ips.txt) | HoneyDB Community Honeypot (API) | **23,570**                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Ergänzung |
