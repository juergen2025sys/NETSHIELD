...
| 🔶 [`blacklist_confidence40_ipv4.txt`](blacklist_confidence40_ipv4.txt) | Mittleres bis hohes Vertrauen · Score ≥ 40 | **4,130,147**                                                                                                                                                                                                                                                                                           | Erweiterte Filterregeln |
...
| 🍯 [`honeydb_ips.txt`](honeydb_ips.txt) | HoneyDB Community Honeypot (API) | **21,280**                                                                                                                                                                                                                                                                                           | Ergänzung |
