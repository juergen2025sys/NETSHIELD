...
|---|---|---:|---|
| 🛡️ [`active_blacklist_ipv4.txt`](active_blacklist_ipv4.txt) | Aktive Bedrohungen · letzte 30 Tage · Score ≥ 65 | **419,824**                                                                                                                                                                                                                                                                                                                                                                                                                                                          | OPNsense / pfSense / Firewall |
...
| 📦 [`combined_threat_blacklist_ipv4.txt`](combined_threat_blacklist_ipv4.txt) | Alle IPs · 180-Tage-Fenster | **5,753,303**                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Audit / SIEM |
...
| 🍯 [`honeydb_ips.txt`](honeydb_ips.txt) | HoneyDB Community Honeypot (API) | **21,696**                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Ergänzung |
