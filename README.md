...
|---|---|---:|---|---|
| [`active_blacklist_ipv4.txt`](active_blacklist_ipv4.txt) | Aktive Bedrohungen (30T + Conf≥50) | **2,661,264** | 8x täglich | **OPNsense / Firewall** |
| [`combined_threat_blacklist_ipv4.txt`](combined_threat_blacklist_ipv4.txt) | Alle IPs (180 Tage) | **3,477,277** | 8x täglich | Audit / SIEM |
...
| [`tor_exit_nodes.txt`](tor_exit_nodes.txt) | Tor Exit Nodes | **7,655** | täglich 23:30 | Anonymisierung blockieren |
...
| [`honeypot_ips.txt`](honeypot_ips.txt) | Honeypot-bestätigte IPs | **13,801** | täglich 23:00 | Ergänzung |
