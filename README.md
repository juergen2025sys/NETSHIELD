...
|---|---|---:|---|---|
| [`active_blacklist_ipv4.txt`](active_blacklist_ipv4.txt) | Aktive Bedrohungen (30T + Conf≥65) | **2,191,752**                                                                                                                                                                                                                        | 8x täglich | **OPNsense / Firewall** |
| [`combined_threat_blacklist_ipv4.txt`](combined_threat_blacklist_ipv4.txt) | Alle IPs (180 Tage) | **3,861,960**                                                                                                                                                                                                                        | 8x täglich | Audit / SIEM |
| [`blacklist_confidence40_ipv4.txt`](blacklist_confidence40_ipv4.txt) | Mittleres/Hohes Vertrauen (Score ≥40) | **2,677,856**                                                                                                                                                                                                                        | 8x täglich | Zusätzliche Filterregeln |
| [`watchlist_confidence20to39_ipv4.txt`](watchlist_confidence20to39_ipv4.txt) | Watchlist (Score 25–39) | **350,302**                                                                                                                                                                                                                        | 8x täglich | Monitoring |
| [`cve_exploit_ips.txt`](cve_exploit_ips.txt) | CVE-Exploit & C2-Server | **227,965**                                                                                                                                                                                                                        | täglich 04:00 | IDS/IPS |
