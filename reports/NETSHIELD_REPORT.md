# 🛡 NETSHIELD Report
**Aktualisiert:** 2026-07-08 01:35 UTC
...
|---|---|---:|---|
| ✅ `combined_threat_blacklist_ipv4.txt` | Stufe 1 – Alle IPs (180 Tage) | **7,434,072** | 2026-07-08 03:24 CEST (Europe/Berlin) |
| ✅ `active_blacklist_ipv4.txt` | Stufe 2 – Aktiv (30 Tage + Conf≥65) | **398,168** | 2026-07-08 03:24 CEST (Europe/Berlin) |
| ✅ `blacklist_confidence40_ipv4.txt` | Mittleres/Hohes Vertrauen (≥40/100) → OPNsense | **5,748,821** | 2026-07-08 01:30 UTC |
| ✅ `watchlist_confidence25to39_ipv4.txt` | Watchlist (Score 25-39/100) | **50,834** | 2026-07-08 01:30 UTC |
| ✅ `cve_exploit_ips.txt` | CVE Exploit IPs | **32,478** | 2026-07-07 07:29 UTC |
| ✅ `bot_detector_blacklist_ipv4.txt` | Bot-Detector Blacklist | **1,267,951** | 2026-07-08 03:02 CEST (Europe/Berlin) |
| ✅ `honeypot_ips.txt` | Honeypot IPs | **120,075** | 2026-07-07 23:43 UTC |
| ✅ `honigtopf_ips.txt` | Honigtopf Community Honeypot (API) | **11,654** | 2026-07-08 01:02 UTC |
...
---
*Automatisch generiert von NETSHIELD Report Generator · 2026-07-08 01:35 UTC*