# 🛡 NETSHIELD Report
**Aktualisiert:** 2026-08-26 22:28 CEST (Europe/Berlin)
...
|---|---|---:|---|
| ✅ `combined_threat_blacklist_ipv4.txt` | Stufe 1 – Alle IPs (180 Tage) | **9,615,440** | 2026-08-26 22:15 CEST (Europe/Berlin) |
| ✅ `active_blacklist_ipv4.txt` | Stufe 2 – Aktiv (30 Tage + Conf≥65) | **883,966** | 2026-08-26 22:15 CEST (Europe/Berlin) |
| ❌ `blacklist_confidence40_ipv4.txt` | Mittleres/Hohes Vertrauen (≥40/100) → OPNsense | **0** | – |
| ✅ `watchlist_confidence25to39_ipv4.txt` | Watchlist (Score 25-39/100) | **60,907** | 2026-08-26 22:22 CEST (Europe/Berlin) |
| ✅ `cve_exploit_ips.txt` | CVE Exploit IPs | **29,235** | 2026-08-26 06:30 CEST (Europe/Berlin) |
| ✅ `bot_detector_blacklist_ipv4.txt` | Bot-Detector Blacklist | **1,310,480** | 2026-08-26 21:28 CEST (Europe/Berlin) |
| ✅ `honeypot_ips.txt` | Honeypot IPs | **1,814,995** | 2026-08-26 21:28 CEST (Europe/Berlin) |
...
---
*Automatisch generiert von NETSHIELD Report Generator · 2026-08-26 22:28 CEST (Europe/Berlin)*