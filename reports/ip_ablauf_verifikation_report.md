...
Lauf: 2026-09-01 16:25 CEST (Europe/Berlin)
...
ℹ️ **176,895 Treffer sind ein legitimer Watchlist-Tages-Cap-Backlog und kein Anti-Churn-Rückfall.** Der aktuelle Combined-State meldet 227,569 noch wartende 30-Tage-Kandidaten (State-Tag: 2026-09-01). Diese IPs stehen im Watchlist-Ledger, aber nicht in `active_blacklist_ipv4.txt`; sie duerfen bis zu einem spaeteren 2.000er-Tages-Slot voruebergehend im Output bleiben.

⚠️ **77 IP(s) gefunden, die laut Ablauf-Liste dauerhaft draussen sein sollten, aber trotzdem in einer aktuellen Output-Datei stehen** - liegt unter der Alarm-Schwelle (300), daher KEIN Issue-Alarm. Laut Bug-21-Diagnose (ledger_diagnose.yml) vermutlich eine kurzlebige Sync-Verzoegerung, keine echte Regression:

| Datei | Anzahl Rückfälle | Beispiele |
|---|---:|---|
| active_blacklist_ipv4.txt | 77 | 101.53.250.20, 103.160.234.194, 103.182.69.27, 104.207.57.110, 104.207.57.255, ... |
| combined_threat_blacklist_ipv4_part1.txt | 40 | 101.53.250.20, 103.160.234.194, 103.182.69.27, 104.207.57.110, 104.207.57.255, ... |
| combined_threat_blacklist_ipv4_part2.txt | 37 | 118.96.142.15, 119.156.228.186, 122.167.158.186, 122.183.40.107, 122.252.253.2, ... |
| blacklist_confidence40_ipv4_part1.txt | 77 | 101.53.250.20, 103.160.234.194, 103.182.69.27, 104.207.57.110, 104.207.57.255, ... |
...
- Seit letztem Lauf: 📈 +10,396 (Anstieg) (jetzt 9,819,809 IPs)
- Seit Zyklus-Start (2026-08-23): 📈 +423,770 (Anstieg)
- Letzter combined-Cleanup-Pass: 0 IPs durch Ablauf entfernt (davon 0 Watchlist/30T, 0 Active/180T), 1,808,952 neue IPs hinzugekommen (davon 1,633,284 direkt wieder durch Aufnahme-Filter entfernt: <2 Feeds & kein HQ) | 25 IPs heute per Kreuzbestätigung (2. Feed innerhalb 7 Tage) doch aufgenommen (zusätzlich: 193,208 CIDR-Aggregate)
- Neue IPs (Summe letzter Läufe): 14,391,733 (Summe letzte 8 Läufe / ~24h)
- Entfernte IPs (Summe letzter Läufe): 180,555 (Summe letzte 8 Läufe / ~24h)
  - davon Watchlist/30 Tage: 180,555 (Summe letzte 8 Läufe / ~24h)
  - davon Active/180 Tage: 0 (Summe letzte 8 Läufe / ~24h)
- Netto-Wachstum (~24h): 📈 +211,869 (~24h)
- Erfolgsquote letzte 16 combined-Läufe: 15/15 erfolgreich (100%, nur echte Erfolge/Fehlschläge gezählt) | zusätzlich 1 cancelled (nicht gewertet), Zeitraum 2026-08-31T20:55 bis 2026-09-01T14:18 UTC
