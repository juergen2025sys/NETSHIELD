...
Lauf: 2026-09-05 10:59 CEST (Europe/Berlin)
...
| Datum | Vorhergesagt | Bisher eingefroren | Fortschritt |
|---|---:|---:|---:|
| 2026-09-05 (heute) | 173,665 | 484,561 | 279% |
| 2026-09-07 | 663,981 | 0 | 0% |
| 2026-09-08 | 662,941 | 0 | 0% |
...
- ❌ **Rückfall:** 445 eingefrorene IP(s) stehen trotzdem in aktuellen Output-Dateien - der Anti-Churn-Fix greift hier NICHT wie erwartet.

## Wiederauftauch-Prüfung

ℹ️ **176,467 Treffer sind ein legitimer Watchlist-Tages-Cap-Backlog und kein Anti-Churn-Rückfall.** Der aktuelle Combined-State meldet 342,781 noch wartende 30-Tage-Kandidaten (State-Tag: 2026-09-05). Diese IPs stehen im Watchlist-Ledger, aber nicht in `active_blacklist_ipv4.txt`; sie duerfen bis zu einem spaeteren 2.000er-Tages-Slot voruebergehend im Output bleiben.

❌ **445 IP(s) gefunden, die laut Ablauf-Liste dauerhaft draussen sein sollten, aber trotzdem in einer aktuellen Output-Datei stehen - der Fix greift hier NICHT wie erwartet (Issue-Alarm ausgeloest, Schwelle 300):**

| Datei | Anzahl Rückfälle | Beispiele |
|---|---:|---|
| active_blacklist_ipv4.txt | 224 | 101.53.250.20, 102.129.153.207, 102.129.56.183, 102.64.41.246, 102.88.111.27, ... |
| combined_threat_blacklist_ipv4_part1.txt | 117 | 101.53.250.20, 102.129.153.207, 102.129.56.183, 102.64.41.246, 102.88.111.27, ... |
| combined_threat_blacklist_ipv4_part2.txt | 328 | 113.161.44.1, 113.23.35.151, 113.57.184.205, 115.186.103.226, 115.241.25.146, ... |
| blacklist_confidence40_ipv4_part1.txt | 224 | 101.53.250.20, 102.129.153.207, 102.129.56.183, 102.64.41.246, 102.88.111.27, ... |
...
- Seit letztem Lauf: 📈 +2,272 (Anstieg) (jetzt 11,038,257 IPs)
- Seit Zyklus-Start (2026-08-23): 📈 +1,642,218 (Anstieg)
- Letzter combined-Cleanup-Pass: 155,449 IPs durch Ablauf entfernt (davon 0 Watchlist/30T, 155,449 Active/180T), 1,017,727 neue IPs hinzugekommen (davon 832,443 direkt wieder durch Aufnahme-Filter entfernt: <2 Feeds & kein HQ) | 70 IPs heute per Kreuzbestätigung (2. Feed innerhalb 7 Tage) doch aufgenommen (zusätzlich: 187,334 CIDR-Aggregate)
- Neue IPs (Summe letzter Läufe): 8,142,096 (Summe letzte 8 Läufe / ~24h)
- Entfernte IPs (Summe letzter Läufe): 644,010 (Summe letzte 8 Läufe / ~24h)
  - davon Watchlist/30 Tage: 4,000 (Summe letzte 8 Läufe / ~24h)
  - davon Active/180 Tage: 640,010 (Summe letzte 8 Läufe / ~24h)
- Netto-Wachstum (~24h): 📉 -157,061 (~24h) ⚠️ **schrumpft aktuell netto** - mehr entfernt als neu aufgenommen
- Erfolgsquote letzte 16 combined-Läufe: 16/16 erfolgreich (100%, nur echte Erfolge/Fehlschläge gezählt), Zeitraum 2026-09-04T16:14 bis 2026-09-05T08:26 UTC
