...
❌ **447 IP(s) gefunden, die laut Ablauf-Liste dauerhaft draussen sein sollten, aber trotzdem in einer aktuellen Output-Datei stehen - der Fix greift hier NICHT wie erwartet (Issue-Alarm ausgeloest, Schwelle 300):**
...
- Seit letztem Lauf: 📈 +1,655 (Anstieg) (jetzt 11,039,912 IPs)
...
- Netto-Wachstum (~24h): 📉 -157,227 (~24h) ⚠️ **schrumpft aktuell netto** - mehr entfernt als neu aufgenommen
