...
| Liste | Anzahl |
|---|---:|
| Watchlist (30-Tage-Pfad) | 8307 |
| Active (180-Tage-Pfad) | 832377 |
...
ℹ️ **7,988 Treffer sind ein legitimer Watchlist-Tages-Cap-Backlog und kein Anti-Churn-Rückfall.** Der aktuelle Combined-State meldet 548,444 noch wartende 30-Tage-Kandidaten (State-Tag: 2026-09-15). Diese IPs stehen im Watchlist-Ledger, aber nicht in `active_blacklist_ipv4.txt`; sie duerfen bis zu einem spaeteren 2.000er-Tages-Slot voruebergehend im Output bleiben.

✅ 0 echte Rückfälle nach Bereinigung - 191,725 legitime Active→Watchlist-Treffer; 1 legitime Watchlist→Active-Treffer; 7,988 erklaerte Watchlist-Cap-Backlog-Treffer. Sonst keine Auffaelligkeit. Der Fix haelt.
