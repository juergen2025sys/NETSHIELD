...
**Aktualisiert:** 2026-07-05 09:46 UTC
...
| `Production Health` | Drift: bot_detector_blacklist_ipv4.txt | bot_detector_blacklist_ipv4.txt: 17,949 → 200,550 (+1017%) – extremes Wachstum, vermutlich Parser-/Dedup-Bug |
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 98.9 MB (>= 95 MB) – naechster git push kann am 100 MB Limit scheitern. Splitting/Truncate-Logik fehlt oder Schwelle anpassen. |
...
| Level | Check | Detail |
|---|---|---|
| 🔴 CRITICAL | Drift: bot_detector_blacklist_ipv4.txt | bot_detector_blacklist_ipv4.txt: 17,949 → 200,550 (+1017%) – extremes Wachstum, vermutlich Parser-/Dedup-Bug |
| 🔴 CRITICAL | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 98.9 MB (>= 95 MB) – naechster git push kann am 100 MB Limit scheitern. Splitting/Truncate-Logik fehlt oder Schwelle anpassen. |
...
---
*Generiert: 2026-07-05 09:46 UTC | 24 Workflow-Dateien geprüft*