...
**Aktualisiert:** 2026-07-18 04:12 UTC
...
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 106.2 MB (>= 95 MB) – naechster git push kann am 100 MB Limit scheitern. Splitting/Truncate-Logik fehlt oder Schwelle anpassen. |
...
| `Production Health` | Push-Limit Naehe | blacklist_confidence40_ipv4.txt: 81.6 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🔴 CRITICAL | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 106.2 MB (>= 95 MB) – naechster git push kann am 100 MB Limit scheitern. Splitting/Truncate-Logik fehlt oder Schwelle anpassen. |
...
| 🟡 WARN | Push-Limit Naehe | blacklist_confidence40_ipv4.txt: 81.6 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-07-18 04:12 UTC | 23 Workflow-Dateien geprüft*