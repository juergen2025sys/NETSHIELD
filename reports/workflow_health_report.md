...
**Aktualisiert:** 2026-06-13 10:07 UTC
...
| Datei | Check | Detail |
|---|---|---|
| `Production Health` | Drift: honeypot_ips.txt | honeypot_ips.txt: 108,613 → 74,207 (-32%) – starker Rückgang seit letztem Check |
...
| `Production Health` | Push-Limit Naehe | seen_db_backup.json.gz: 88.7 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🔴 CRITICAL | Drift: honeypot_ips.txt | honeypot_ips.txt: 108,613 → 74,207 (-32%) – starker Rückgang seit letztem Check |
| 🟡 WARN | Push-Limit Naehe | seen_db_backup.json.gz: 88.7 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-13 10:07 UTC | 24 Workflow-Dateien geprüft*