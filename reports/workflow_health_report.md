...
**Aktualisiert:** 2026-06-20 10:12 UTC
...
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 88.0 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🔴 CRITICAL | active ⊆ conf40 Subset-Invariante verletzt | 343 IPs in active fehlen in conf40 (0.088% von active). Ursache vermutlich Cache-Drift zwischen combined- und confidence-Workflow (siehe BUG-CACHE-DRIFT). Der Heilungs-Pfad in update_confidence_blacklist.yml hat entweder nicht gegriffen (Cap >10%) oder wurde umgangen. |
| 🟡 WARN | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 88.0 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-20 10:12 UTC | 23 Workflow-Dateien geprüft*