...
**Aktualisiert:** 2026-07-10 10:29 UTC
...
| 🔴 CRITICAL | active ⊆ conf40 Subset-Invariante verletzt | 1,208 IPs in active fehlen in conf40 (0.289% von active). Ursache vermutlich Cache-Drift zwischen combined- und confidence-Workflow (siehe BUG-CACHE-DRIFT). Der Heilungs-Pfad in update_confidence_blacklist.yml hat entweder nicht gegriffen (Cap >10%) oder wurde umgangen. |
...
---
*Generiert: 2026-07-10 10:29 UTC | 24 Workflow-Dateien geprüft*