...
**Aktualisiert:** 2026-06-23 10:43 UTC
...
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 81.8 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
| `Production Health` | Push-Limit Naehe | state/seen_db_backup.json.gz.part000: 87.9 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🟡 WARN | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 81.8 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
| 🟡 WARN | Push-Limit Naehe | state/seen_db_backup.json.gz.part000: 87.9 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-23 10:43 UTC | 23 Workflow-Dateien geprüft*