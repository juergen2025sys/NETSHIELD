...
**Aktualisiert:** 2026-06-30 10:35 UTC
...
| Datei | Check | Detail |
|---|---|---|
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 94.7 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| 🟡 WARN | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 94.7 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-30 10:35 UTC | 23 Workflow-Dateien geprüft*