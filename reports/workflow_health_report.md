...
**Aktualisiert:** 2026-07-17 04:22 UTC

**Workflows:** 25 | ✅ 24 OK | ⚠️ 0 Warnung | ❌ 2 Fehler
...
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 105.8 MB (>= 95 MB) – naechster git push kann am 100 MB Limit scheitern. Splitting/Truncate-Logik fehlt oder Schwelle anpassen. |
...
| `Production Health` | Push-Limit Naehe | blacklist_confidence40_ipv4.txt: 81.3 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🔴 CRITICAL | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 105.8 MB (>= 95 MB) – naechster git push kann am 100 MB Limit scheitern. Splitting/Truncate-Logik fehlt oder Schwelle anpassen. |
...
| 🟡 WARN | Push-Limit Naehe | blacklist_confidence40_ipv4.txt: 81.3 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-07-17 04:22 UTC | 25 Workflow-Dateien geprüft*