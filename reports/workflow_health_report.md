...
**Aktualisiert:** 2026-06-25 05:14 UTC
...
| Datei | Check | Detail |
|---|---|---|
| `update_combined_blacklist.yml` | IP-Listen Duplikate | combined_threat_blacklist_ipv4.txt: 6,554,080 doppelte IPs (50.0% von 13,108,160) – Scoring-Verzerrung und aufgeblähte Datei |
...
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 89.2 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
| `Production Health` | Push-Limit Naehe | state/seen_db_backup.json.gz.part000: 92.6 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🟡 WARN | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 89.2 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
| 🟡 WARN | Push-Limit Naehe | state/seen_db_backup.json.gz.part000: 92.6 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-25 05:14 UTC | 23 Workflow-Dateien geprüft*