...
**Aktualisiert:** 2026-07-20 10:20 UTC
...
| `Production Health` | Drift: honeypot_ips.txt | honeypot_ips.txt: 196,587 → 121,963 (-38%) – starker Rückgang seit letztem Check |
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 107.2 MB (>= 95 MB) – naechster git push kann am 100 MB Limit scheitern. Splitting/Truncate-Logik fehlt oder Schwelle anpassen. |
...
| `Production Health` | Push-Limit Naehe | blacklist_confidence40_ipv4.txt: 82.4 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🔴 CRITICAL | Drift: honeypot_ips.txt | honeypot_ips.txt: 196,587 → 121,963 (-38%) – starker Rückgang seit letztem Check |
| 🔴 CRITICAL | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 107.2 MB (>= 95 MB) – naechster git push kann am 100 MB Limit scheitern. Splitting/Truncate-Logik fehlt oder Schwelle anpassen. |
...
| 🟡 WARN | Push-Limit Naehe | blacklist_confidence40_ipv4.txt: 82.4 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-07-20 10:20 UTC | 23 Workflow-Dateien geprüft*