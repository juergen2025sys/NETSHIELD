...
**Aktualisiert:** 2026-09-03 14:05 CEST (Europe/Berlin)

**Workflows:** 30 | ✅ 24 OK | ⚠️ 8 Warnung | ❌ 1 Fehler
...
| Datei | Check | Detail |
|---|---|---|
| `auto_feed_refresh.yml` | MIN_FEED_SUCCESS_RATIO ungueltig | MIN_FEED_SUCCESS_RATIO=0 ist ungueltig – Guard muss > 0 sein |
...
| `update_combined_blacklist.yml` | Cache-Key Prefix falsch | Save-Key 'netshield-auto-feed-daily-v1-combined-${{' hat nicht den erwarteten Prefix 'v2' – potenzieller Cache-Overwrite |
...
| `auto_feed_refresh.yml` | ❌ | 1 | 0 | `15 2 * * *` |
...
---
*Generiert: 2026-09-03 14:05 CEST (Europe/Berlin) | 30 Workflow-Dateien geprüft*