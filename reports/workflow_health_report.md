...
| `Production Health` | Push-Limit Naehe | blacklist_confidence40_ipv4.txt: 83.8 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| 🟡 WARN | Push-Limit Naehe | blacklist_confidence40_ipv4.txt: 83.8 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-07-24 09:32 UTC | 23 Workflow-Dateien geprüft*