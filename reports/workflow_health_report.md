...
**Aktualisiert:** 2026-06-25 10:20 UTC
...
| Datei | Check | Detail |
|---|---|---|
| `update_combined_blacklist.yml` | IP-Listen Duplikate | combined_threat_blacklist_ipv4.txt: 6,558,558 doppelte IPs (50.0% von 13,117,116) – Scoring-Verzerrung und aufgeblähte Datei |
...
| `Production Health` | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 89.3 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
| Level | Check | Detail |
|---|---|---|
| 🟡 WARN | Push-Limit Naehe | combined_threat_blacklist_ipv4.txt: 89.3 MB (>= 80 MB) – Push-Limit-Reserve schrumpft, Splitting-Strategie pruefen. |
...
---
*Generiert: 2026-06-25 10:20 UTC | 23 Workflow-Dateien geprüft*