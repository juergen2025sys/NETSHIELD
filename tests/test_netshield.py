...
class TestRedirectSecretHeaderProtection(unittest.TestCase):
    """Regressionstests fuer SECURITY FIX 2026-08-31."""
    ...
    def test_cross_origin_redirect_strips_sensitive_headers(self):
        ...
        self.assertEqual(names.get("accept"), "text/plain")
    ...
    def test_same_origin_redirect_keeps_auth_headers(self):
        ...
        names = {k.lower(): v for k, v in req.header_items()}
        self.assertEqual(names.get("authorization"), "Bearer TOPSECRET")
        self.assertEqual(names.get("x-secret-token"), "SECRET123")
